---
name: ProxySwitch Design System
colors:
  surface: '#f9f9ff'
  surface-dim: '#d8d9e3'
  ...
  status-active-green: '#166534'
  status-pending-amber: '#B45309'
  status-failed-red: '#B91C1C'
  bg-running: '#DCFCE7'
  bg-via-child: '#FEF9C3'
  bg-via-correlated: '#FED7AA'
  bg-checking: '#DBEAFE'
  bg-exited: '#F3F4F6'
  bg-failed: '#FEE2E2'
  accent-clash: '#22C55E'
  accent-v2ray: '#3B82F6'
  accent-direct: '#6B7280'
typography:
  nav-tab:
    fontFamily: Inter
    fontSize: 14px
